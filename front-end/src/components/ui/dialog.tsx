  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "border-border bg-background text-foreground fixed top-1/2 left-1/2 z-50 grid max-h-[min(90vh,48rem)] w-full max-w-3xl -translate-x-1/2 -translate-y-1/2 gap-0 overflow-y-auto rounded-xl border p-0 shadow-lg transition duration-200 ease-in-out",
